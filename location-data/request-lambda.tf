...
resource "aws_lambda_permission" "apigwR" {
  ...
  source_arn = "arn:aws:execute-api:ap-northeast-2:896673219691:${aws_api_gateway_rest_api.jkApi.id}/*/${aws_api_gateway_method.proxy.http_method}${aws_api_gateway_resource.proxy.path}"
}